 ...
 * @param path The path of the target field relative to the root of the document
 *             object.
 *
 ...
 *
 * @param doc The document.
 * @param path The path of the array field relative to the root of the document
 *             object.
 * @param subpath The path of the target field relative the root of each item in
 *                the array field.
 *
